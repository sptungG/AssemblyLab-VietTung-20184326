#• Create a new project to implement this	
	#function: find the element with the largest
	#absolute value in a list of integers.
#• Assuming that this list is store in an integer
	#array and we know the number of elements in
	#it.
